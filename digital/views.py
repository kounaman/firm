...
def register(request):
   ...
   #"" if request.method == "POST":
       ...
       # newRegister = Registers.objects.register(email=email, password =password, confirmpassword =confirmpassword)
       # newRegisters.save()
       #"""" message = "Enregistrement réussi avec succés"
    # if form.is_valid():
    #     form.save()
...
def geographie(request):
    return render(request, 'geographie.html')